...
class Test:
	param = []				# parameter values of the 16 parameters
	classification = ""     # class names based on cost (best, fair, worst)
	cost = 0.0		 		# minimum cost for the given parameter values
	for_loop = 4     		# no. of for loops in atax2.src2.c
	nested_loop = 2  		# no. of nested loops in atax2.src2.c
...
def parser(input_file):
    ...
    for i in range(0, n):
    	if ( objectList[i].cost <= p) :
    		objectList[i].classification = "Autotune-best"
    		#print "best : ", objectList[i].cost
    	elif ( objectList[i].cost > p and objectList[i].cost <= q) :
    		objectList[i].classification = "Autotune-fair"
    		#print "mediocre : ", objectList[i].cost
    	else :
    		objectList[i].classification = "Autotune-worst"
	...
	# prints out the cost.... testing purpose
    #print "minimum cost: ", a	
    #print "maximum cost: ", b
    #print "best range: ", p
    #print "worst range: ", q
    
    #shuffle the object list to mix the classes
    shuffle(objectList)
    
    # Open file to write output
    foo = open("autotune.txt", "w")
    
    # autotuning file structure
    foo.write( "@RELATION autotune_data")
    foo.write("\n")
    #print "@RELATION autotune_data", foo
    foo.write("@ATTRIBUTE parameter1 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter2 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter3 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter4 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter5 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter6 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter7 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter8 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter9 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter10 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter11 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter12 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter13 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter14 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter15 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter16 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter17 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter18 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE parameter19 NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE for_loop NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE nested_loop NUMERIC")
    foo.write("\n")
    foo.write("@ATTRIBUTE class {CLASS,Autotune-best,Autotune-fair,Autotune-worst}")
    foo.write("\n\n")
    foo.write("@DATA")
    foo.write("\n")
    ...
    #for i in range(0, n):
    	#print objectList[i].param, ", ", objectList[i].classification
    	#print("".join(str(x) for x in objectList[i].param))
    	#print ', '.join(objectList[i].param)
    	#print str(objectList[i].param).strip('[]') 
    	# strips the brackets from the list and prints only the values
    	#print ",".join(map(repr, objectList[i].param)),",", objectList[i].for_loop, ",", objectList[i].nested_loop, ",", objectList[i].classification
    	foo.write(",".join(map(repr, objectList[i].param)))
    	foo.write(",")
    	foo.write('%d' % objectList[i].for_loop)
    	foo.write(",")
    	foo.write('%d' % objectList[i].nested_loop)
    	foo.write(",")
    	foo.write(objectList[i].classification)
    	foo.write("\n")
